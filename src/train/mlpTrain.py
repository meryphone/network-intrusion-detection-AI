"""
MLP Classifier Training Script with Dynamic Ensemble approach.
Implements Stage 2 of the hybrid intrusion detection system using online learning.

Usage:
    python mlpTrain.py
    python mlpTrain.py --train path/to/train.csv --test path/to/test.csv
    python mlpTrain.py --stage1-model path/to/iso_forest.pkl
"""
...
def create_mlp_model():
    """Create MLP Classifier with configured hyperparameters."""
...
def _train_single(train_path, test_path, stage1_model_path, batch_size, output_dir=None, models_dir=None):
    ...
    print("=" * 60)
    print("MLP CLASSIFIER TRAINING (DYNAMIC ONLINE LEARNING)")
    print("=" * 60)
    ...
    # Save model
    model_file = model_dir / "mlp_classifier.pkl"
